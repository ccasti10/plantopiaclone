...
const control_plagas_controller_1 = require("./contoller/control-plagas.controller");
const control_plagas_service_1 = require("./service/control-plagas.service");
...
exports.ControlPlagasModule = ControlPlagasModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [control_plagas_service_1.ControlPlagasService],
    })
], ControlPlagasModule);
