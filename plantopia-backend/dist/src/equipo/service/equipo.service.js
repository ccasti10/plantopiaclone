...
let EquipoService = class EquipoService {
    constructor() {
        ...
        this.equipo = [
            new equipo_entity_1.Equipo("Diseño_UX_UI", "Amalia Luna", [
                "Amalia Luna",
                "Valeria Gutiérrez",
                "Macarena Campos",
                "Valentina Tabilo"
            ]),
            new equipo_entity_1.Equipo("Front-End", "Cristian Levio", [
                "Cristian Levio",
                "Sebastián Rubilar",
                "Esteban Menares"
            ]),
            new equipo_entity_1.Equipo("Back-End", "Christian Castillo", [
                "Christian Castillo",
                "Flor Granados",
                "Rodrigo Cabello",
                "Camilo Orellana"
            ]),
            new equipo_entity_1.Equipo("Mobile", "María Elena Valencia", [
